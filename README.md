...
| [Paradise.Hosting](src/Paradise.Hosting) | — | Application lifetime, fixed-step loops, capture scheduling and pooled snapshot transport |
| [Paradise.Hosting.Desktop](src/Paradise.Hosting.Desktop) | — | SDL/offscreen hosting and one layered feature configuration for simulation and rendering |
