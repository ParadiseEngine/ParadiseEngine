...
internal sealed class OperationGuard
{
    ...
    /// <summary>Enters an operation scope, incrementing the counter.</summary>
    ...
    /// <summary>Waits for all in-flight operations to complete.</summary>
    ...
    /// <summary>Waits for all in-flight operations to complete with a timeout.</summary>
    ...
    /// <summary>RAII scope that decrements the operation counter when disposed.</summary>
