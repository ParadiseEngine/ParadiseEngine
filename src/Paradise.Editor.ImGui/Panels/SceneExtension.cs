...
/// <summary>The Scene panel, contributed the way any extension contributes one.</summary>
/// <remarks>
/// <para>
/// The viewport: the host model drawn over a render target.
/// </para>
/// <para>
...
/// </para>
/// </remarks>
public sealed class SceneExtension : IShellExtension
{
    public const string OwnerId = "editor.panel.scene";
