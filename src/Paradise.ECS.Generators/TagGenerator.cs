...
public class TagGenerator : IIncrementalGenerator
{
    ...
    private static void GenerateAddTagExtension(SourceProductionContext context, string rootNamespace, string tagMaskType)
    {
        var sb = new StringBuilder();
        sb.AppendLine("// <auto-generated/>");
        sb.AppendLine("#nullable enable");
        ...
        sb.AppendLine($"namespace {rootNamespace};");
        sb.AppendLine();
        sb.AppendLine("/// <summary>Extension methods for adding tag support using project-specific EntityTags and TagMask.</summary>");
        sb.AppendLine("public static class GeneratedAddTagExtensions");
        sb.AppendLine("{");
        sb.AppendLine("    /// <param name=\"builder\">The builder to wrap.</param>");
        sb.AppendLine("    /// <typeparam name=\"TBuilder\">The builder type.</typeparam>");
        sb.AppendLine("    extension<TBuilder>(TBuilder builder) where TBuilder : unmanaged, global::Paradise.ECS.IComponentsBuilder");
        sb.AppendLine("    {");
        sb.AppendLine("        /// <summary>");
        sb.AppendLine("        /// Adds a tag to the entity being built.");
        sb.AppendLine("        /// Uses the project-specific EntityTags and TagMask types.");
        sb.AppendLine("        /// </summary>");
        sb.AppendLine("        /// <typeparam name=\"TTag\">The tag type to add.</typeparam>");
        sb.AppendLine("        /// <param name=\"tag\">A dummy value for type inference (use default).</param>");
        sb.AppendLine("        /// <returns>A WithTagBuilder that includes the EntityTags component with the specified tag.</returns>");
        sb.AppendLine("        [global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]");
        sb.AppendLine($"        public global::Paradise.ECS.WithTagBuilder<TTag, TBuilder, global::{rootNamespace}.EntityTags, {tagMaskType}> AddTag<TTag>(TTag tag)");
        sb.AppendLine("            where TTag : global::Paradise.ECS.ITag");
        sb.AppendLine("        {");
        sb.AppendLine($"            return new global::Paradise.ECS.WithTagBuilder<TTag, TBuilder, global::{rootNamespace}.EntityTags, {tagMaskType}> {{ InnerBuilder = builder }};");
        sb.AppendLine("        }");
        sb.AppendLine("    }");
        sb.AppendLine("}");

        context.AddSource("AddTagExtension.g.cs", sb.ToString());
    }
