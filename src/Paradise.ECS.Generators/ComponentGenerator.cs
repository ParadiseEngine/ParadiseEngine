...
public class ComponentGenerator : IIncrementalGenerator
{
    ...
    private static void GenerateComponentRegistry(
        SourceProductionContext context, List<TypeInfo> components, string rootNamespace,
        string? chunkAggregateComponentFqn)
    {
        var sb = new StringBuilder();
        sb.AppendLine("// <auto-generated/>");
        sb.AppendLine("#nullable enable");
        ...
        sb.AppendLine("    {");
        sb.AppendLine("        var components = new (global::System.Type Type, global::System.Guid Guid, int Size, int Alignment, int ManualId, int ChunkAggregate, global::System.Action<global::Paradise.ECS.ComponentId> SetId)[]");
        sb.AppendLine("        {");
        ...
        foreach (var c in components)
        {
            ...
            // A per-chunk slot the size of the component itself: EntityTags aggregates tag masks,
            // so the union is exactly one mask wide.
            var chunkAggregate = c.FullyQualifiedName == chunkAggregateComponentFqn
                ? $"global::{c.FullyQualifiedName}.Size"
                : "0";
            sb.AppendLine($"            (typeof(global::{c.FullyQualifiedName}), {guid}, global::{c.FullyQualifiedName}.Size, global::{c.FullyQualifiedName}.Alignment, {manualId}, {chunkAggregate}, (global::Paradise.ECS.ComponentId id) => global::{c.FullyQualifiedName}.TypeId = id),");
        }
        ...
        sb.AppendLine("            typeInfosBuilder[id.Value] = new global::Paradise.ECS.ComponentTypeInfo(id, comp.Size, comp.Alignment, comp.ChunkAggregate);");
        sb.AppendLine("        }");
        sb.AppendLine();
    ...
    private static void GenerateSharedWorldHelper(
        SourceProductionContext context,
        ...
        string tagMaskType)
    {
        ...
        sb.AppendLine("/// Factory for creating SharedWorld instances that manage shared resources across multiple worlds.");
        sb.AppendLine("/// Uses the project's ComponentRegistry and default configuration.");
        sb.AppendLine("/// </summary>");
