...
{
    public static IEnumerable<int> GetRandomSeeds50()
    {
        return Enumerable.Range(0, 50);
    }

    public static IEnumerable<int> GetRandomSeeds10()
    {
    ...
    [Test]
    [MethodDataSource(nameof(GetRandomSeeds50))]
    public void should_create_blob_tree_with_random_branches(int seed)
    {
    ...
    [Test]
    [MethodDataSource(nameof(GetRandomSeeds10))]
    public void should_create_array_of_blob_tree_with_random_branches(int seed)
    {
    ...
    [Test]
    [MethodDataSource(nameof(GetRandomSeeds50))]
    public void should_create_ptr_of_blob_tree_with_random_branches(int seed)
    {
        var nodes = CreateRandomIntTree(100, seed);
    ...
    [Test]
    [MethodDataSource(nameof(GetRandomSeeds50))]
    public void should_create_blob_tree_of_ptr_with_random_branches(int seed)
    {
    ...
    [Test]
    [MethodDataSource(nameof(GetRandomSeeds10))]
    public void should_create_complex_blob_with_blob_tree(int seed)
    {
