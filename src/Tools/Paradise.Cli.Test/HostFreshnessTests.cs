...
public class HostFreshnessTests
{
    ...
    private static MemoryFileSystem Built()
    {
        ...
        Write(fileSystem, "/engine/src/Simulation/Paradise.ECS/Paradise.ECS.csproj", "<Project Sdk=\"Microsoft.NET.Sdk\" />", s_restored.AddMinutes(-5));
        Write(fileSystem, "/engine/src/Simulation/Paradise.ECS/World.cs", "class World {}", s_restored);
        ...
        Write(fileSystem, s_assets, """
            {
              ...
              "libraries": {
                ...
                "Paradise.ECS/0.39.0": { "type": "project", "path": "../../engine/src/Simulation/Paradise.ECS/Paradise.ECS.csproj", "msbuildProject": "../../engine/src/Simulation/Paradise.ECS/Paradise.ECS.csproj" },
    ...
    public async Task an_untouched_tree_is_fresh_and_owes_no_restore()
    {
        ...
        {
            "/repo/Game.Launcher", "/repo/Game.Core", "/engine/src/Simulation/Paradise.ECS",
    ...
    public async Task a_source_edit_in_a_project_the_csproj_never_names_is_stale_without_a_restore()
    {
        ...
        using var fileSystem = Built();
        fileSystem.SetLastWriteTime("/engine/src/Simulation/Paradise.ECS/World.cs", s_built.AddMinutes(1));
    ...
    {
        using var fileSystem = new RefusingFileSystem("/engine/src/Simulation/Paradise.ECS");
        Write(fileSystem, s_csproj, "<Project />", s_restored.AddMinutes(-5));
        Write(fileSystem, "/engine/src/Simulation/Paradise.ECS/World.cs", "class World {}", s_restored);
        Write(fileSystem, s_assets, """{ "libraries": { "Paradise.ECS/1.0.0": { "type": "project", "msbuildProject": "../../engine/src/Simulation/Paradise.ECS/Paradise.ECS.csproj" } }, "project": { "frameworks": { "net10.0": { } } } }""", s_restored);
