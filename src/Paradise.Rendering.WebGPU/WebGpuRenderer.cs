...
public sealed class WebGpuRenderer : IDisposable
{
    ...
    /// render thread only. Single-owner semantics: assignment REPLACES any previous subscriber
    /// (this is one seam, not an event) — compose inside your own delegate if you need more.</summary>
