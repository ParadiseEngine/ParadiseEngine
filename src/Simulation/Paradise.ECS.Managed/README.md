...
```bash
dotnet test --project src/Simulation/Paradise.ECS.Managed.Test/Paradise.ECS.Managed.Test.csproj
dotnet test --project src/Simulation/Paradise.ECS.Generators.Test/Paradise.ECS.Generators.Test.csproj
