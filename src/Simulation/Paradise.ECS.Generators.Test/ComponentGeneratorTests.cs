...
/// <summary>Tests for SuppressGlobalUsingsAttribute functionality.</summary>
...
/// <summary>Tests for EntityTags auto-generation when Paradise.ECS.Tag is referenced.</summary>
public class ComponentGeneratorEntityTagsAutoGenerationTests
{
    /// <summary>Verifies that EntityTags is auto-generated when tags are defined.</summary>
    [Test]
    public async Task WithTags_AutoGeneratesEntityTags()
    {
        const string source = """
            using Paradise.ECS;
        ...
        var entityTags = sources.FirstOrDefault(s => s.HintName == "EntityTags.g.cs").Source;
    ...
    /// <summary>Verifies that user-defined EntityTags in the correct namespace prevents auto-generation.</summary>
    [Test]
    ...
    public async Task UserDefinedEntityTags_InDifferentNamespace_StillAutoGeneratesRootNamespaceEntityTags()
    {
        ...
        var autoGeneratedEntityTags = sources.FirstOrDefault(s => s.HintName == "EntityTags.g.cs").Source;
    ...
    /// <summary>Verifies the World alias points to TaggedWorld when tags are defined.</summary>
    [Test]
    public async Task WithTags_WorldAliasUsesTaggedWorld()
    {
        const string source = """
            using Paradise.ECS;
        ...
        await Assert.That(aliases).Contains("Tags enabled");
    }
...
/// <summary>Tests for ComponentGenerator duplicate ID detection (PECS015).</summary>
public class ComponentGeneratorDuplicateManualIdTests
{
    /// <summary>Verifies that the PECS015 diagnostic descriptor is properly defined.</summary>
    [Test]
