...
public readonly ref struct QueryBuilder<TMask> where TMask : unmanaged, IBitSet<TMask>
{
    ...
    /// <summary>Creates a new query builder with the specified description.</summary>
    ...
    /// <summary>Creates a new empty query builder.</summary>
    /// <returns>A new query builder with no constraints.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static QueryBuilder<TMask> Create() => new();

    /// <summary>Adds a required component constraint.</summary>
    ...
    /// <summary>Adds a required component constraint by component ID.</summary>
    ...
    /// <summary>Adds an excluded component constraint.</summary>
    ...
    /// <summary>Adds an excluded component constraint by component ID.</summary>
    ...
    /// <summary>Adds an "any of" component constraint.</summary>
    ...
    /// <summary>Adds an "any of" component constraint by component ID.</summary>
    ...
    /// <summary>The immutable query description.</summary>
    ...
    /// <summary>Builds a query from this description.</summary>
    ...
    /// <summary>Implicit conversion to immutable query description.</summary>
