...
```sh
dotnet test --project src/Platform/Paradise.Hosting.Test/Paradise.Hosting.Test.csproj --output normal
dotnet build src/Platform/Paradise.Hosting.CoyoteTest -c Release
dotnet run --project src/Platform/Paradise.Hosting.CoyoteTest -c Release --no-build -- 200
```
