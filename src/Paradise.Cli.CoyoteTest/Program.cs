...
public static class Program
{
    public static int Main(string[] args)
    {
        ...
        Console.WriteLine($"Running Coyote CLI watch-tray tests with {iterations} iterations...");
        Console.WriteLine();

        var tests = new (string Name, Func<Task> Action)[]
        {
            ("RebuildRacingWait_IsNotLost", WatchSignalsTests.RebuildRacingWait_IsNotLost),
