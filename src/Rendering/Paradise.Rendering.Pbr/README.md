...
src/Rendering/Paradise.Rendering.Browser.Test/Paradise.Rendering.Browser.Test.csproj` and
`node --test src/Rendering/Paradise.Rendering.Browser.Test/ResourceLifetime.test.mjs` from the repository root.
