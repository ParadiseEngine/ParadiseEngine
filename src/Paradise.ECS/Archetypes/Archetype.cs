...
public sealed class Archetype<TMask, TConfig> : IArchetype<TMask, TConfig>
    ...
    where TConfig : IConfig, new()
{
    ...
    /// <summary>The current number of chunks in this archetype.</summary>
    ...
    public Archetype(int id, nint layoutData, ChunkManager chunkManager, ImmutableArray<ComponentTypeInfo> typeInfos)
    {
    ...
    /// <summary>Clears all entities from this archetype, freeing all chunks.</summary>
    public void Clear()
    {
    ...
    /// <summary>Frees trailing empty chunks.</summary>
